...
#=================================================
                ...
                if msg.to in pro["Protectjoin"]:
                    try:
                        ...
                        pass
                if msg.to in pro["Auto kick"]:
                    try:
                        del pro["Auto kick"][msg.to]
                    except:
                        pass
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
                ...
                for i in gid:
                        ...
                        if h == ng:
                            ...
                            dz.sendMessage(msg.to,"sᴜᴄᴄᴇs ʀᴇsᴇᴛ ["+ h +"] ɢʀᴏᴜᴘ")
#=================================================
            elif msg.text in ["دعوت قفل"]:
                pro["Protectinvite"][msg.to]=True
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
                dz.sendMessage(msg.to,"قفل دعوت فعال شد")
            elif msg.text in ["دعوت آزاد"]:
                del pro["Protectinvite"][msg.to]
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
...
#=================================================
            elif msg.text in ["کنسل قفل"]:
                pro["Protectcancl"][msg.to]=True
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
                dz.sendMessage(msg.to,"ᴄᴀɴᴄᴇʟ ᴏɴ ᴘʀᴏᴛᴇᴄᴛ")
            elif msg.text in ["کنسل آزاد"]:
                del pro["Protectcancl"][msg.to]
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
...
#=================================================                
                            ...
                            try:
                            	...
                            	pass                         
#=================================================
            elif msg.text in ["جوین قفل"]:
                pro["Protectjoin"][msg.to]=True
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
                dz.sendMessage(msg.to,"ᴊᴏɪɴ ᴏɴ ᴘʀᴏᴛᴇᴄᴛ")
            elif msg.text in ["جوین آزاد"]:
                del pro["Protectjoin"][msg.to]
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
...
#=================================================
                ...
                pro["Auto kick"][msg.to]=False
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
                dz.sendMessage(msg.to, "غیر فعال شد داداج")
            elif "UnlockAuto kick grup: " in msg.text:
                ng = msg.text.replace("UnlockAuto kick grup: ","")
                gid = dz.getGroupIdsJoined()
                for i in gid:
                        h = dz.getGroup(i).name
                        if h == ng:
                            ...
                            pass
            elif "LockAuto kick grup: " in msg.text:
                ng = msg.text.replace("LockAuto kick grup: ","")
                gid = dz.getGroupIdsJoined()
                for i in gid:
                        h = dz.getGroup(i).name
                        if h == ng:
                            pro["Auto kick"][i]=True
                            with open('pro.json', 'w') as fp:
                                json.dump(pro, fp, sort_keys=True, indent=4)
                            dz.sendMessage(msg.to,"sᴜᴄᴄᴇs sᴇᴛ ᴛᴏ ["+ h +"] ɢʀᴏᴜᴘ")
                        else:
                            pass
            elif msg.text in ["Auto kick"]:
                pro["Auto kick"] = {}
                with open('pro.json', 'w') as fp:
                    json.dump(pro, fp, sort_keys=True, indent=4)
                dz.sendMessage(msg.to,"ᴄʟᴇᴀʀ")
...
#=============================================
                ...
                if msg.to in pro["Auto kick"]: md+="╠➣ᴀᴜᴛᴏ ᴋɪᴄᴋ : ✔\n╠════════════════════\n╠➣line://ti/p/~Masih.00\n╠➣line://ti/p/~Masih.00\n╚════════════════════"
                else:md+="╠➣ᴀᴜᴛᴏ ᴋɪᴄᴋ : ❌\n╠════════════════════\n╠➣line://ti/p/~Masih.00\n╠➣line://ti/p/~Masih.00\n╚════════════════════"
...
#=============================================
                ...
                with open('setting.json', 'w') as fp:
                    json.dump(wait, fp, sort_keys=True, indent=4)
                dz.sendMessage(msg.to,"Auto join فعال شد")
            elif msg.text in ["Auto join off"]:
                wait["Auto join"]=False
                with open('setting.json', 'w') as fp:
                    json.dump(wait, fp, sort_keys=True, indent=4)
                dz.sendMessage(msg.to,"Auto join غیر فعال شد")
#=============================================
...
#=============================================
                ...
                if pro["prosider"] == {}:
                    ...
                    jo = "\n╠ ➽ ".join(str(i) for i in nban)
                    dz.sendMessage(msg.to,"╔══════════════\n╠⟦ ᴘ sɪᴅᴇʀ ɢʀᴜᴘ ⟧\n╔══════════════\n╠ ➽ %s\n╚══════════════\n╠⟦ Total: %s ⟧\n"%(jo,str(len(cban)))+"╚══════════════")
            elif "ListAuto kick" == msg.text:
                if pro["Auto kick"] == {}:
                    dz.sendMessage(msg.to,"ɴᴏ ɢʀᴜᴘ ᴀᴅᴅᴇᴅ")
                else:
                    mc = []
                    for mi_d in pro["Auto kick"]:
                        mc.append(mi_d)
                    pass
                    cban = dz.getGroups(mc)
                    nban = []
