...
#==================[ RECEIVE_MESSAGE ]===============
        if op.type == 25:
                ...
                if msg.text in ["Help"]:
                    ...
                    dz.sendMessage(receiver, None, contentMetadata={'mid': dzMID}, contentType=13)
                    dz.sendMessage(receiver, None, contentMetadata={"STKID":"52114123","STKPKGID":"11539","STKVER":"1"}, contentType=7)
        ...
        if op.type == 25:
            ...
            if msg.text in ["My id"]:
                if msg.toType == 2:
               	...
               	dz.sendMessage(receiver, None, contentMetadata={'mid': dzMID}, contentType=13)
               	dz.sendMessage(receiver, None, contentMetadata={"STKID": "1002262","STKPKGID": "150228","STKVER": "1" }, contentType=7)
...
#=================================================
			...
			#=================================================
            elif msg.text in ["stc"]:

                dz.sendMessage(msg.to, None, contentMetadata={"STKID":"1002262","STKPKGID":"150228","STKVER":"1"}, contentType=7)
                
            elif msg.text in ["صبح بخیر"]:
                ...
                dz.sendMessage(msg.to,"جوووووووووون جووووووووون    \n ڪاشـ دنیــــا برعڪس بــود . . . \n  \n (\____/) \n ( ͡ ⚫͜ ʖ͡⚫  \n  \ 👉🏿    \👉🏿")
                
            elif msg.text in ["سلام"]:

                dz.sendMessage(msg.to,"خـــــوبے عـــــزیـــز")
